...
@section('content')
    <div class="mb-4">
        <a href="{{ route('petugas.peminjamans.index') }}" class="btn btn-outline-secondary btn-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="h6"><span class="badge bg-success">{{ ucfirst($peminjaman->alat->kondisi) }}</span>
                            </p>
                        </div>
                    </div>
                    <div>
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <p class="h6">{{ $peminjaman->pengembalian->tanggal_kembali->format('d-m-Y') }}</p>
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-muted">Kondisi Alat</label>
                            <p class="h6">{{ ucfirst($peminjaman->pengembalian->kondisi_alat) }}</p>
                        </div>
                        <div>
                            <label class="form-label text-muted">Denda</label>
                            <p class="h6"><span
                                    class="badge bg-danger">Rp {{ number_format($peminjaman->pengembalian->denda, 0, ',', '.') }}</span>
                            </p>
                        </div>
                    </div>
                </div>
